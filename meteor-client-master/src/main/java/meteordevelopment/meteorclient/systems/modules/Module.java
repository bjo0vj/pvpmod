...
public abstract class Module implements ISerializable<Module>, Comparable<Module> {
    ...
    public void sendToggledMsg() {
        ...
        meteordevelopment.meteorclient.systems.modules.render.PvPHudModule pvp = Modules.get().get(meteordevelopment.meteorclient.systems.modules.render.PvPHudModule.class);
        if (pvp != null) pvp.addToggleMessage(title, isActive());
    }
